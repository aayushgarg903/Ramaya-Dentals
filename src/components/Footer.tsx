          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16 relative z-10">
            ...
            <div className="space-y-6">
              ...
              <p className="text-cream/70 text-sm leading-relaxed max-w-xs">
                {CLINIC_CONFIG.tagline} in {CLINIC_CONFIG.shortAddress}, Haryana. We blend advanced technology with a compassionate approach to give you the smile you deserve.
              </p>
