...
const photos = [
  {
    ...
    alt: 'Ramaya Dentals clinic exterior – Model Town, Rohtak',
    label: 'Our Clinic',
    caption: 'Located in Model Town, Rohtak',
  },
  {
    src: '/images/clinic/waiting_room.jpg',
    alt: 'Bright waiting room at Ramaya Dentals',
    label: 'Waiting Area',
    caption: 'Spacious & comfortable seating',
  },
  {
    src: '/images/clinic/dental_chair.jpg',
    alt: 'Modern dental treatment chair at Ramaya Dentals',
    label: 'Treatment Room',
    caption: 'State-of-the-art dental equipment',
  },
  {
    src: '/images/clinic/doctor_treatment.jpg',
    alt: 'Doctor in PPE performing dental treatment',
    label: 'Expert Care',
    caption: 'Safe, hygienic & professional procedures',
  },
  {
    src: '/images/clinic/doctor_patient.jpg',
    alt: 'Dr. Deepanshi with a young patient – happy treatment experience',
    label: 'Happy Patient',
    caption: 'Kids love visiting us! 👍',
  },
];
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-14 space-y-4">
          ...
          <p className="text-cream/60 max-w-2xl mx-auto font-medium text-base md:text-lg">
            ...
            Take a peek inside Ramaya Dentals.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-4">
          ...
          {/* Row 1: Clinic Exterior – full-width hero */}
          <div
          ...
          {/* Row 2: Waiting Room + Treatment Room */}
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 h-[260px] md:h-[340px]">
            {photos.slice(1, 3).map((photo, i) => (
              <div
                key={i}
                className="group cursor-pointer rounded-3xl overflow-hidden relative shadow-lg h-full"
          ...
          {/* Row 3: Doctor Treatment + Happy Patient */}
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 h-[260px] md:h-[340px]">
