      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        ...
        <div className="lg:col-span-5 space-y-6 text-center lg:text-left">
          ...
          <p className="text-forest/75 text-sm md:text-base font-medium leading-relaxed">
            Our friendly team provides personalized dental treatments designed to keep your whole family smiling. Experience modern dentistry with a gentle, caring touch right here in Haryana.
          </p>
